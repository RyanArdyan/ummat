    ...
    <ul class="list-unstyled topnav-menu float-right mb-0">
        <li class="dropdown notification-list">
            <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                ...
                {{-- <img src="{{ (auth()->user()->foto !== null) ? asset('storage/foto_profil/' . auth()->user()->foto . '') : asset('storage/foto_profil/default_foto.jpg') }}" class="rounded-circle foto_profil"> --}}
                <img class="rounded-circle foto_profil" src="/storage/foto_profil/default_foto.jpg" alt="">
