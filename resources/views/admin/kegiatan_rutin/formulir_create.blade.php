        ...
        <div class="col-sm-12">
            <form id="form_tambah">
                ...
                <div class="form-group">
                    ...
                    <input id="jam_mulai" name="jam_mulai" class="jam_mulai_input input form-control" type="time" style="width: 100px">
                    {{-- pesan error --}}
                ...
                <div class="form-group">
                    ...
                    <input id="jam_selesai" name="jam_selesai" class="jam_selesai_input input form-control" type="time" style="width: 100px">
                    {{-- pesan error --}}
                ...
                {{-- tipe_kegiatan --}}
                <div class="form-group">
                    <label for="tipe_kegiatan">Tipe Kegiatan<span class="text-danger"> *</span></label>
                    <select class="form-control" name="tipe_kegiatan" id="tipe_kegiatan">
                        {{-- value dari attribute value akan masuk ke dalam table kegiatan --}}
                        <option value="Kegiatan Rutin">Kegiatan Rutin</option>
                        <option value="Kegiatan Sekali">Kegiatan Sekali</option>
                    </select>
                </div>
