...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('donasi_manual', function (Blueprint $table) {
            ...
            // foreign key atau kunci asing, relasinya adalah 1 donasi_manual milik atau di donasikan oleh 1 user dan 1 user memiliki banyak donasi_manual atau 1 user bisa melakkan banyak donasi_manual
            ...
            $table->enum('status', ['Belum Cek', 'Benar', 'Nipu'])->default('Belum Cek');
            // tipe enum
